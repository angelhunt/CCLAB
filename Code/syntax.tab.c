...
{
       0,    42,    42,    52,    58,    67,    74,    81,    90,    97,
     110,   117,   126,   133,   142,   148,   157,   170,   177,   186,
     193,   202,   209,   218,   231,   241,   247,   256,   263,   270,
     277,   284,   291,   304,   310,   319,   328,   335,   344,   352,
     365,   372,   379,   386,   393,   400,   407,   414,   421,   428,
     435,   442,   449,   456,   463,   470,   477,   486,   493
};
#endif
...
static const char *const yytname[] =
{
  ...
  "IF", "ELSE", "WHILE", "LOWER_THAN_ELSE", "NEG", "$accept", "Program",
...
{
      47,   -58,     8,    15,   -58,    47,    66,   -58,    -7,     9,
     -58,   -58,   -58,    18,   -58,    35,    -1,    22,    47,    36,
     -58,    19,    50,    47,   -58,    19,    48,    47,   -58,    19,
      39,    67,   -58,   -58,    54,    32,    -4,    72,    75,   -58,
     -58,    71,   -58,    47,   -58,   -58,   -58,    74,    64,    64,
      64,    64,    76,    88,   -58,    70,    32,    77,    64,   -58,
      19,   -58,    59,     0,     0,   139,    92,    64,    64,   -58,
     -58,   -58,   104,    64,    64,    64,    64,    64,    64,    64,
      64,   184,   -58,   -58,   108,    89,   -58,   -58,   154,   169,
     -58,   184,   204,    26,    26,     0,     0,   197,   123,    64,
     -58,    32,    32,   -58,   -58,    69,   -58,    32,   -58
};
...
{
     -58,   -58,   106,   -58,    91,     4,   -58,   -58,   -58,   -18,
     -58,    81,   -58,    96,    73,   -57,   -11,   -58,    65,   -58,
     -48,    27
};
...
{
      63,    64,    65,    66,     6,    58,    21,    36,    72,     6,
      81,    41,    35,     8,    84,    11,    40,   -15,    22,    88,
      89,    22,    80,    29,    32,    91,    92,    93,    94,    95,
      96,    97,    98,    18,    72,    45,    46,    47,    19,    77,
      78,    20,    36,    48,   105,   106,    23,    29,    80,    49,
     108,    84,    50,    34,     1,     2,    23,    28,    51,    52,
      42,    53,    45,    46,    47,     1,     2,    45,    46,    47,
      48,    13,    14,    39,    43,    48,    49,    44,    59,    50,
      83,    49,    60,    71,    50,    72,    73,    74,    75,    76,
      77,    78,    79,    22,    62,    69,    67,   107,    87,    80,
      72,    73,    74,    75,    76,    77,    78,    79,    68,    90,
     100,    12,    33,    24,    80,    99,    72,    73,    74,    75,
      76,    77,    78,    79,    61,    82,   104,     0,     0,    70,
      80,    72,    73,    74,    75,    76,    77,    78,    79,     0,
       0,     0,     0,     0,     0,    80,   103,    72,    73,    74,
      75,    76,    77,    78,    79,     0,     0,     0,     0,     0,
      86,    80,    72,    73,    74,    75,    76,    77,    78,    79,
       0,     0,     0,     0,     0,   101,    80,    72,    73,    74,
      75,    76,    77,    78,    79,     0,     0,     0,     0,     0,
     102,    80,    72,    73,    74,    75,    76,    77,    78,    79,
       0,     0,     0,     0,     0,    72,    80,    74,    75,    76,
      77,    78,    72,     0,     0,    75,    76,    77,    78,    80,
       0,     0,     0,     0,     0,     0,    80
};

static const yytype_int8 yycheck[] =
{
      48,    49,    50,    51,     0,     9,     7,    25,     8,     5,
      58,    29,    23,     5,    62,     0,    27,    24,    22,    67,
      68,    22,    22,    19,     5,    73,    74,    75,    76,    77,
      78,    79,    80,    24,     8,     3,     4,     5,    20,    13,
      14,     6,    60,    11,   101,   102,    24,    43,    22,    17,
     107,    99,    20,     3,    18,    19,    24,    21,    26,    27,
      21,    29,     3,     4,     5,    18,    19,     3,     4,     5,
      11,     5,     6,    25,     7,    11,    17,    23,     6,    20,
      21,    17,     7,     6,    20,     8,     9,    10,    11,    12,
      13,    14,    15,    22,    20,    25,    20,    28,     6,    22,
       8,     9,    10,    11,    12,    13,    14,    15,    20,     5,
      21,     5,    21,    17,    22,     7,     8,     9,    10,    11,
      12,    13,    14,    15,    43,    60,    99,    -1,    -1,    56,
      22,     8,     9,    10,    11,    12,    13,    14,    15,    -1,
      -1,    -1,    -1,    -1,    -1,    22,    23,     8,     9,    10,
      11,    12,    13,    14,    15,    -1,    -1,    -1,    -1,    -1,
      21,    22,     8,     9,    10,    11,    12,    13,    14,    15,
      -1,    -1,    -1,    -1,    -1,    21,    22,     8,     9,    10,
      11,    12,    13,    14,    15,    -1,    -1,    -1,    -1,    -1,
      21,    22,     8,     9,    10,    11,    12,    13,    14,    15,
      -1,    -1,    -1,    -1,    -1,     8,    22,    10,    11,    12,
      13,    14,     8,    -1,    -1,    11,    12,    13,    14,    22,
      -1,    -1,    -1,    -1,    -1,    -1,    22
};
...
{
       0,    18,    19,    33,    34,    35,    37,    38,     5,    39,
      40,     0,    34,     5,     6,    36,    41,    42,    24,    20,
       6,     7,    22,    24,    45,    37,    48,    49,    21,    37,
      43,    44,     5,    36,     3,    48,    41,    50,    51,    25,
      48,    41,    21,     7,    23,     3,     4,     5,    11,    17,
      20,    26,    27,    29,    45,    46,    47,    52,     9,     6,
       7,    43,    20,    52,    52,    52,    52,    20,    20,    25,
      46,     6,     8,     9,    10,    11,    12,    13,    14,    15,
      22,    52,    50,    21,    52,    53,    21,     6,    52,    52,
       5,    52,    52,    52,    52,    52,    52,    52,    52,     7,
      21,    21,    21,    23,    53,    47,    47,    28,    47
};
...
#line 42 "./syntax.y" /* yacc.c:1646  */
    {
        ...
        data.i = (yylsp[0]).first_line;
        (yyval.np) = NewNode("Program", &data, false); 
...
#line 52 "./syntax.y" /* yacc.c:1646  */
    {
        ...
        memset((void *)&data, 0, sizeof(Data));
        data.i = -1;
        (yyval.np) = NewNode("ExtDefList", &data, false);
        }
...
#line 67 "./syntax.y" /* yacc.c:1646  */
    {
        Data data;
        memset((void *)&data, 0, sizeof(Data));
        data.i = (yylsp[-2]).first_line;
        (yyval.np) = NewNode("ExtDef", &data, false);
...
#line 90 "./syntax.y" /* yacc.c:1646  */
    {
        ...
        memset((void *)&data, 0, sizeof(Data));
        data.i = (yylsp[0]).first_line;
        (yyval.np) = NewNode("ExtDecList", &data, false);
        TreeInsert((yyval.np), 1, (yyvsp[0].np));
        }
...
#line 110 "./syntax.y" /* yacc.c:1646  */
    {
        ...
        memset((void *)&data, 0, sizeof(Data));
        data.i = (yylsp[0]).first_line;
        (yyval.np) = NewNode("Specifier", &data, false); 
        TreeInsert((yyval.np), 1, (yyvsp[0].np));
        }
...
#line 126 "./syntax.y" /* yacc.c:1646  */
    {
        Data data;
        memset((void *)&data, 0, sizeof(Data));
        data.i = (yylsp[-4]).first_line;
        (yyval.np) = NewNode("StructSpecifier", &data, false); 
...
#line 142 "./syntax.y" /* yacc.c:1646  */
    {
        ...
        memset((void *)&data, 0, sizeof(Data));
        data.i = -1;
        (yyval.np) = NewNode("OptTag", &data, false);
        }
...
#line 157 "./syntax.y" /* yacc.c:1646  */
    {
        ...
        memset((void *)&data, 0, sizeof(Data));
        data.i = (yylsp[0]).first_line;
        (yyval.np) = NewNode("Tag", &data, false);
        TreeInsert((yyval.np), 1, (yyvsp[0].np));
        }
...
#line 170 "./syntax.y" /* yacc.c:1646  */
    {
        ...
        memset((void *)&data, 0, sizeof(Data));
        data.i = (yylsp[0]).first_line;
        (yyval.np) = NewNode("VarDec", &data, false);
        TreeInsert((yyval.np), 1, (yyvsp[0].np));
        }
...
#line 177 "./syntax.y" /* yacc.c:1646  */
    {
        Data data;
        memset((void *)&data, 0, sizeof(Data));
        data.i = (yylsp[-3]).first_line;
        (yyval.np) = NewNode("VarDec", &data, false);
        TreeInsert((yyval.np), 4, (yyvsp[-3].np), (yyvsp[-2].np), (yyvsp[-1].np), (yyvsp[0].np));
        }
...
#line 186 "./syntax.y" /* yacc.c:1646  */
    {
        ...
        memset((void *)&data, 0, sizeof(Data));
        data.i = (yylsp[-3]).first_line;
        (yyval.np) = NewNode("FunDec", &data, false);
        TreeInsert((yyval.np), 4, (yyvsp[-3].np), (yyvsp[-2].np), (yyvsp[-1].np), (yyvsp[0].np));
       }
...
#line 202 "./syntax.y" /* yacc.c:1646  */
    {
        ...
        memset((void *)&data, 0, sizeof(Data));
        data.i = (yylsp[-2]).first_line;
        (yyval.np) = NewNode("VarList", &data, false);
        TreeInsert((yyval.np), 3, (yyvsp[-2].np), (yyvsp[-1].np), (yyvsp[0].np));
        }
...
#line 218 "./syntax.y" /* yacc.c:1646  */
    {
        ...
        memset((void *)&data, 0, sizeof(Data));
        data.i = (yylsp[-1]).first_line;
        (yyval.np) = NewNode("ParamDec", &data, false);
        TreeInsert((yyval.np), 2, (yyvsp[-1].np), (yyvsp[0].np));
         }
...
#line 231 "./syntax.y" /* yacc.c:1646  */
    {
        ...
        memset((void *)&data, 0, sizeof(Data));
        data.i = (yylsp[-3]).first_line;
        (yyval.np) = NewNode("CompSt", &data, false);
        TreeInsert((yyval.np), 4, (yyvsp[-3].np), (yyvsp[-2].np), (yyvsp[-1].np), (yyvsp[0].np));
...
#line 241 "./syntax.y" /* yacc.c:1646  */
    {
        ...
        memset((void *)&data, 0, sizeof(Data));
        data.i = -1;
        (yyval.np) = NewNode("StmtList", &data, false);
        }
...
#line 256 "./syntax.y" /* yacc.c:1646  */
    {
        ...
        memset((void *)&data, 0, sizeof(Data));
        data.i = (yylsp[-1]).first_line;
        (yyval.np) = NewNode("Stmt", &data, false);
        TreeInsert((yyval.np), 2, (yyvsp[-1].np), (yyvsp[0].np));
     }
...
#line 304 "./syntax.y" /* yacc.c:1646  */
    {
        ...
        memset((void *)&data, 0, sizeof(Data));
        data.i = -1;
        (yyval.np) = NewNode("DefList", &data, false);
        }
...
#line 319 "./syntax.y" /* yacc.c:1646  */
    {
        ...
        memset((void *)&data, 0, sizeof(Data));
        data.i = (yylsp[-2]).first_line;
        (yyval.np) = NewNode("Def", &data, false);
        TreeInsert((yyval.np), 3, (yyvsp[-2].np), (yyvsp[-1].np), (yyvsp[0].np));
    }
...
#line 328 "./syntax.y" /* yacc.c:1646  */
    {
        ...
        memset((void *)&data, 0, sizeof(Data));
        data.i = (yylsp[0]).first_line;
        (yyval.np) = NewNode("DecList", &data, false);
        TreeInsert((yyval.np), 1, (yyvsp[0].np));
        }
...
#line 344 "./syntax.y" /* yacc.c:1646  */
    {
        ...
        memset((void *)&data, 0, sizeof(Data));
        data.i = (yylsp[0]).first_line;
        (yyval.np) = NewNode("Dec", &data, false);
        TreeInsert((yyval.np), 1, (yyvsp[0].np));
...
#line 365 "./syntax.y" /* yacc.c:1646  */
    {
        ...
        memset((void *)&data, 0, sizeof(Data));
        data.i = (yylsp[-2]).first_line;
        (yyval.np) = NewNode("Exp", &data, false);
        TreeInsert((yyval.np), 3, (yyvsp[-2].np), (yyvsp[-1].np), (yyvsp[0].np));
    }
...
#line 486 "./syntax.y" /* yacc.c:1646  */
    {
        ...
        memset((void *)&data, 0, sizeof(Data));
        data.i = (yylsp[-2]).first_line;
        (yyval.np) = NewNode("Args", &data, false);
        TreeInsert((yyval.np), 3, (yyvsp[-2].np), (yyvsp[-1].np), (yyvsp[0].np));
     }
